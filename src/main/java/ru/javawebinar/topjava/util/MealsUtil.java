...
public class MealsUtil {
    public static void main(String[] args) {
        ...
        List<MealWithExceed> mealsWithExceeded = getFilteredWithExceeded(meals, LocalTime.of(0, 0), LocalTime.of(23, 0), 2000);
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static Collection<MealWithExceed> getAllMealWithExceeded (Collection<Meal> meals, int calories) {
